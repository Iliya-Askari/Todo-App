...
urlpatterns = [
    path('registrations/', view.RegestrationsApiView.as_view(), name='registrations'),
    path('token/create/', view.CustomCreateTokenApiView.as_view(), name='create-token'),
    path('token/discard/', view.CustomDiscardTokenApiView.as_view(), name='discard-token'),
    ...
    path('activations/resend/', view.ActivationsRecendApiView.as_view(), name='activation-resend'),
